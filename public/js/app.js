...
loadMore = function loadMore() {
  ...
  axios.get("/comments?page=".concat(parseInt(btn.dataset.currentPage) + 1), {
...
appendComment = function appendComment(data) {
  var temp = "<div class=\"tw-w-full tw-py-5 tw-px-4 tw-h-auto tw-mb-4 tw-rounded-lg uk-animation-slide-right\" style=\"background: rgba(0,0,0,.05);\">\n                <div class=\"tw-flex tw-space-x-2 sm:tw-space-x-4\">\n                    <div class=\"tw-flex-none tw-h-12 tw-w-12 sm:tw-h-14 sm:tw-w-14 md:tw-h-14 md:tw-w-14 tw-rounded-full tw-bg-brown-lighter tw-relative\">\n                        <span class=\"tw-font-extrabold tw-text-white tw-text-center tw-text-1xl tw-p-2 tw-mt-0.5 tw-absolute tw-top-0 tw-left-0 tw-right-0\">\n                            ".concat(data.comment_from[0], "\n                        </span>\n                    </div>\n                    <div class=\"tw-w-full\">\n                        <div class=\"tw-flex tw-justify-between\">\n                            <div>\n                                <p class=\"tw-text-gray-600 sm:tw-text-base lg:tw-text-lg tw-font-semibold\">").concat(data.comment_from, "</p>\n                            </div>\n                            <div class=\"tw-flex-shrink-0\">\n                                <p class=\"tw-text-gray-600 tw-text-xs tw-mt-0.5 sm:tw-text-sm tw-font-light\">").concat(data.created_at, "</p>\n                            </div>\n                        </div>\n                        <div class=\"tw-mt-0.5\">\n                            <p class=\"sm:tw-text-base lg:tw-text-lg white-space comment\">").concat(data.comment_text, "</p>\n                        </div>\n                    </div>\n                </div>\n            </div>");
  return temp;
};

toggleJumlahTamu = function toggleJumlahTamu() {
...
/***/ "./resources/css/invitation-dark.css":
/*!*******************************************!*\
  !*** ./resources/css/invitation-dark.css ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	__webpack_require__.O(undefined, ["css/invitation-dark","css/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/invitation-dark","css/app"], () => (__webpack_require__("./resources/css/app.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/invitation-dark","css/app"], () => (__webpack_require__("./resources/css/invitation-dark.css")))
